...
def main(args):
    ...
    if args.train_index:
        ...
        init_param_path = './checkpoints/init_param_' + args.model_name + '_' + args.dataset_name + '_prune_STE.pth'
    ...
    for epoch in range(args.max_epoch):
        ...
        if test_accuracy > best_test_acc:
            ...
            if args.train_index:
                ...
                param_after_training_path = './checkpoints/final_param_' + args.model_name + '_' + args.dataset_name + '_prune_STE.pth'
