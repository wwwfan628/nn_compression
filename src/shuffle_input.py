...
def main(args):
    ...
    # build model & load parameters from given path
    ...
    optimize_input(model, random_image_tensor, init_indices, label, args)
...
def optimize_input(model, random_image_tensor, init_indices, label, args):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_index', type=int, default=18, help='if true train index, else train in normal way')
    ...
    parser.add_argument('--checkpoint_path', default='./checkpoints/final_param_LeNet5_MNIST_train_index.pth')
